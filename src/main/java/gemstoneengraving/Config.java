...
public class Config {
    ...
    public static final ModConfigSpec.DoubleValue Amber_Value = BUILDER.comment("Amber Basic,Range -1.0~0").defineInRange("amber_multiple",-0.2, -1.0, 0.0);

    public static final ModConfigSpec.DoubleValue Aquamarine_Value = BUILDER.comment("Aquamarine Basic,Range 0.1~0.5").defineInRange("aquamarine_multiple",0.1, 0.1, 0.5);
    ...
    public static final ModConfigSpec.DoubleValue Conch_Pearl = BUILDER.comment("Conch_pearl Basic,Range 0.1~2.0").defineInRange("conch_pearl_multiple",1, 0.1, 2.0);

    public static final ModConfigSpec.DoubleValue Helvite = BUILDER.comment("Helvite Basic,Range 0.05~0.1").defineInRange("helvite_multiple",0.05, 0.01, 0.1);
    ...
    public static final ModConfigSpec.DoubleValue Mica = BUILDER.comment("Mica Basic,Range 0.1~0.5").defineInRange("mica_multiple",0.1, 0.1, 0.5);
    ...
    public static final ModConfigSpec.DoubleValue Sapphire = BUILDER.comment("Sapphire Basic,Range 0.5~3.0").defineInRange("sapphire_multiple",1.0 ,0.5, 3.0);

    public static final ModConfigSpec.DoubleValue Slime_Core = BUILDER.comment("Slime_Core Basic,Range 1.0~3.0").defineInRange("slime_core_multiple",1.5 ,1.0, 3.0);
    ...
    public static final ModConfigSpec.DoubleValue Topaz = BUILDER.comment("Topaz Basic,Range 1.0~2.0").defineInRange("topaz_multiple",1 ,1, 2.0);

    public static final ModConfigSpec.DoubleValue Tsavorite=BUILDER.comment("Tsavorite Basic,Range 0.1~2.0").defineInRange("tsavorite_multiple",0.5,0.1,2.0);
